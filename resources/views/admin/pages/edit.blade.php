...
<div class="section">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-xl font-semibold">Edit Page: {{ $page->title }}</h3>
        ...
        <form action="{{ route('admin.pages.update', $page->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <textarea id="seo_description" name="seo_description" rows="3"
                              ...
                              placeholder="Optional SEO description">{{ old('seo_description', $page->seo_description) }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea id="content" name="content" rows="12"
                          ...
                          placeholder="Write your page content here..." required>{{ old('content', $page->content) }}</textarea>
                @error('content')
                    <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                @enderror
            </div>
...
document.getElementById('title').addEventListener('keyup', function() {
    ...
    if (slugField.getAttribute('data-original') === slugField.value) {
