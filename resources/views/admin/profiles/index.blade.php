...
<div class="section">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.profiles.edit', $user->id) }}" class="neumorph-btn dark:neumorph-btn-dark px-4 py-2 rounded-xl bg-primary text-white hover:bg-primary-dark transition flex items-center justify-center whitespace-nowrap">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="neumorph-3d dark:neumorph-3d-dark rounded-xl overflow-hidden p-6 md:col-span-1">
            <div class="text-center">
                ...
                <!-- Social Links -->
                @if(!empty(array_filter($decodedSocialLinks)))
                <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <h4 class="text-sm font-medium mb-3">Social Links</h4>
                    <div class="flex justify-center space-x-3">
                        @foreach($decodedSocialLinks as $platform => $url)
                        @if($url)
