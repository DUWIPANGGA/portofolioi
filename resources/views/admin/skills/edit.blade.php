...
<div class="section">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-xl font-semibold">Edit Skill</h3>
        ...
        <form action="{{ route('admin.skills.update', $skill->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <select name="user_id" id="user_id" class="input-field dark:input-field w-full" required>
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ $skill->user_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
                    @error('user_id')
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="category" id="category" value="{{ old('category', $skill->category) }}" 
