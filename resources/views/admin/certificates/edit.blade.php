...
@section('subtitle', 'Update certificate details')
        ...
        <form action="{{ route('admin.certificates.update', $certificate->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $certificate->title) }}" 
                ...
                <div>
                    ...
                    <input type="text" id="credential_id" name="credential_id" value="{{ old('credential_id', $certificate->credential_id) }}" 
                           class="w-full input-field dark:input-field">
                    @error('credential_id')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="url" id="credential_url" name="credential_url" value="{{ old('credential_url', $certificate->credential_url) }}" 
                           class="w-full input-field dark:input-field">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center space-x-4">
                        <img src="{{ Storage::url($certificate->image) }}" 
                             ...
                             class="w-32 h-32 object-cover rounded-lg neumorph-inset dark:neumorph-inset-dark">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Current certificate image</p>
                            <button type="button" 
                                    onclick="document.getElementById('remove_image').value = '1'; document.getElementById('current_image').classList.add('hidden');"
                ...
                <!-- New Image -->
                <div class="md:col-span-2">
                    <label for="image" class="block mb-2">New Certificate Image</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4"
                              class="w-full input-field dark:input-field">{{ old('description', $certificate->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="order" name="order" value="{{ old('order', $certificate->order) }}" 
