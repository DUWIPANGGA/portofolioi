...
@section('title', 'Edit Custom Section')
@section('subtitle', 'Update section details')

@section('content')
<div class="section">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-xl font-semibold">Edit Section: {{ $customSection->section_name }}</h3>
    ...
    <div class="neumorph-3d dark:neumorph-3d-dark rounded-xl p-6">
        <form action="{{ route('admin.custom_sections.update', $customSection->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" id="section_name" name="section_name" 
                           ...
                           value="{{ old('section_name', $customSection->section_name) }}" 
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" 
                           ...
                           value="{{ old('title', $customSection->title) }}" 
                ...
                <div>
                    ...
                    <input type="number" id="order" name="order" 
                           ...
                           value="{{ old('order', $customSection->order) }}" 
                           min="0">
                    @error('order')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="is_active" name="is_active" 
                               ...
                               value="1" {{ old('is_active', $customSection->is_active) ? 'checked' : '' }}>
            ...
            <div class="mb-6">
                ...
                <textarea id="content" name="content" rows="6" 
                          ...
                          placeholder="Section content...">{{ old('content', $customSection->content) }}</textarea>
                @error('content')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="custom_data" name="custom_data" rows="4" 
                          ...
                          placeholder='{"key": "value"}'>{{ old('custom_data', $customSection->custom_data ? json_encode($customSection->custom_data, JSON_PRETTY_PRINT) : '') }}</textarea>
                @error('custom_data')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                @enderror
            </div>
