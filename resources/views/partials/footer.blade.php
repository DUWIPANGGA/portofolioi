        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid md:grid-cols-4 gap-8">
                <div class="mb-8 md:mb-0">
                    <a href="#" class="text-2xl font-bold text-gradient mb-4 inline-block">Alex Johnson</a>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Frontend Developer & UI Specialist creating beautiful, functional web experiences.</p>
                    <div class="flex space-x-4">
                        <a href="https://github.com/alexjohnson" target="_blank" class="neumorph-btn w-10 h-10 flex items-center justify-center hover:text-primary transition"><i class="fab fa-github"></i></a>
                        <a href="https://linkedin.com/in/alexjohnson" target="_blank" class="neumorph-btn w-10 h-10 flex items-center justify-center hover:text-primary transition"><i class="fab fa-linkedin-in"></i></a>
                        <a href="https://twitter.com/alexjohnson" target="_blank" class="neumorph-btn w-10 h-10 flex items-center justify-center hover:text-primary transition"><i class="fab fa-twitter"></i></a>
                        <a href="https://dribbble.com/alexjohnson" target="_blank" class="neumorph-btn w-10 h-10 flex items-center justify-center hover:text-primary transition"><i class="fab fa-dribbble"></i></a>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 text-center">
                <p class="text-gray-600 dark:text-gray-400">&copy; 2023 Alex Johnson. All rights reserved.</p>
                <p class="text-gray-500 dark:text-gray-500 text-sm mt-2">Made with <i class="fas fa-heart text-red-500"></i> and <i class="fas fa-coffee text-yellow-600"></i> in San Francisco</p>
            </div>
        </div>
    </footer>