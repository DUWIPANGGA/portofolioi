...
<body class="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300">
    ...
    <!-- Navigation -->
    <nav class="fixed w-full z-50 bg-white bg-opacity-80 dark:bg-gray-900 dark:bg-opacity-80 backdrop-blur-sm py-4 px-6">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            <a href="#" class="text-2xl font-bold text-gradient">Duwipangga</a>
            
            <!-- Desktop Menu -->
            <div class="hidden md:flex items-center space-x-8">
                <a href="#home" class="neumorph-btn px-4 py-2 font-medium hover:text-primary transition">Home</a>
                <a href="#about" class="neumorph-btn px-4 py-2 font-medium hover:text-primary transition">About</a>
                <a href="#skills" class="neumorph-btn px-4 py-2 font-medium hover:text-primary transition">Skills</a>
                <a href="#projects" class="neumorph-btn px-4 py-2 font-medium hover:text-primary transition">Projects</a>
                <a href="#testimonials" class="neumorph-btn px-4 py-2 font-medium hover:text-primary transition">Testimonials</a>
                <a href="#contact" class="neumorph-btn px-4 py-2 font-medium hover:text-primary transition">Contact</a>
                
                <!-- Dark Mode Toggle -->
                <label class="neumorph-toggle">
                    <input type="checkbox" id="darkModeToggle">
                    <span class="neumorph-slider"></span>
                </label>
            </div>
            
            <!-- Mobile Menu Button -->
            <button id="mobileMenuButton" class="md:hidden neumorph-btn w-12 h-12 flex items-center justify-center">
                <i class="fas fa-bars"></i>
            </button>
        </div>
        
        <!-- Mobile Menu -->
        <div id="mobileMenu" class="hidden md:hidden mt-4 p-4 neumorph-3d rounded-xl">
            ...
            <div class="relative section" style="transition-delay: 0.2s">
                ...
                <div class="neumorph-3d w-full max-w-md h-[450px] rounded-3xl overflow-hidden relative transform rotate-3 hover:rotate-0 transition-transform duration-500">
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-end pb-8 pt-24 px-6 text-center">
                        ...
                        <p class="text-primary font-medium mb-4">Web Developer</p>
                            ...
                            <div class="p-6 flex-grow">
                                ...
                                {{-- @if($project->technologies)
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        @php
                                            $techIds = json_decode($project->technologies);
                                            $technologies = $user->technologies->whereIn('id', $techIds);
                                        @endphp
                    ...
                    <div class="neumorph-3d p-8 rounded-3xl">
                        ...
                        <form class="space-y-6" id="contactForm">
                            <div>
                                ...
                                <input type="text" id="name" class="w-full input-field px-4 py-3" placeholder="John Doe" required>
                            </div>
                            <div>
                                <label for="email" class="block mb-2 font-medium">Your Email</label>
                                <input type="email" id="email" class="w-full input-field px-4 py-3" placeholder="john@example.com" required>
                            </div>
                            <div>
    ...
    <!-- Footer -->
    <footer class="bg-white dark:bg-gray-800 py-12 px-4">
        <div class="max-w-6xl mx-auto text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400">&copy; {{ date('Y') }} {{ $user->name }}. All rights reserved.</p>
        </div>
    </footer>
